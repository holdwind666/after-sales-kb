...
from kb_paths import cache_root, data_root
...
# Human-verified parameter facts stay in each company's local cache rather
# than the public repository. Add rows to quick_index/param_seeds.tsv and
# rebuild when OCR is unreliable on small technical tables.
DEFAULT_PARAM_SEEDS = []
