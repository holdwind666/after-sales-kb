...
# record_feedback.ps1 - Append one successful after-sales case to the WPS
# synced feedback folder. The next build_chatgpt_corpus.py run will learn it.
#
# ASCII-only file.
